import {Button, Card, Checkbox, Flex, Select, Tag, TagLabel, TagRightIcon, Text,} from "@chakra-ui/react";
...
const ChatArea = ({onData, setIsLoading, getMaskedImage, image, gender, setGender,firstTime,setFirstTime}) => {
